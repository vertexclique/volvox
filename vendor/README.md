...
=======
    ...
    $ cd ~/.emacs.d/vendor
    $ git clone git://github.com/volvox/gist.el.git
...
* Code: `git clone git://github.com/volvox/gist.el.git`
* Home: <http://github.com/volvox/gist.el>
* Bugs: <http://github.com/volvox/gist.el/issues>
